...
SquarePlayer = function(x, y, rot, width, height, density, friction, restitution)
{
	...
	this.coords_physics.push([this.width, 0.0]);
	this.coords_physics.push([this.width, this.height]);
	this.coords_physics.push([0.0, this.height]);
...
SquarePlayer.prototype = new GameObject();	// inherit from GameObject
SquarePlayer.prototype.constructor = SquarePlayer;