...
Square = function(x, y, rot, width, height, density, friction, restitution)
{
	...
	this.coords_physics.push([width, height]);
	this.coords_physics.push([0.0, height]);
...
Square.prototype = new GameObject();	// inherit from GameObject
