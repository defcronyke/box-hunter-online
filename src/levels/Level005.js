...
Level005 = function(objects_on_screen)
{
	objects_on_screen.push(
		new Square((800.0 * 0.02) / 2.0 - 1.5, 11.0, 0.0, 4.2, 0.5, 1.0, 0.05, 0.0) );

	objects_on_screen.push(
		new Square((800.0 * 0.02) / 2.0 + 1.5, 8.0, 0.0, 0.5, 1.3, 1.0, 0.05, 0.0) );

	objects_on_screen.push(
		new Triangle((800.0 * 0.02) / 2.0 - 1.5, 7.0, 0.0, 1.0, 1.0, 1.0, 0.05, 0.0) );

	objects_on_screen.push(
		new Triangle((800.0 * 0.02) / 2.0 - 3.5, 13.0, 0.0, 1.0, 1.0, 1.0, 0.05, 0.0) );

	objects_on_screen.push(
		new Triangle((800.0 * 0.02) / 2.0 + 0.8, 19.0, 0.0, 1.0, 1.0, 1.0, 0.05, 0.0) );
